...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Script d'entraînement du modèle pour la classification des maisons à Poudlard.")
    parser.add_argument('file_path', type=str, help="Chemin du fichier CSV à utiliser pour l'entraînement.")
